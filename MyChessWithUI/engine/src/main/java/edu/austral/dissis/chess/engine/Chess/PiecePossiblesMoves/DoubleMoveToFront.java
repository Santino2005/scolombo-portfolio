...
public class DoubleMoveToFront implements PossibleMoves {
    ...
    public List<Position> possiblePosition(MoveTo moveTo, Board board) {
        ...
        if (board.getPieceByPosition(oneStepForward).isEmpty() && board.getPieceByPosition(twoStepsForward).isEmpty()) {
